...
OWNER_ID = int(getenv("OWNER_ID", "6172048272"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/intaempire123")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/shajjajshhwkkwnanq")

# Set this to True if you want the assistant to automatically leave chats after an interval
AUTO_LEAVING_ASSISTANT = bool(getenv("AUTO_LEAVING_ASSISTANT", Fqalse))
